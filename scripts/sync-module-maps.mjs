...
const audit = item('../ai-system-implementation-audit/README.md', 'AI implementation audit', 'AI 系统实现审查', 'For material wiring, harness or contract uncertainty.', '接入、harness 或契约存在关键不确定性时读取。');
